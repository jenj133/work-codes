...
p2= p + scale_x_discrete(labels=c("CCC"="ECCC (n=62)","EC" = "EC (n = 132)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)","mixed EC/CCC" = "Mixed EC/CCC (n = 2)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 11)"))+
  theme(axis.text.x=element_text(angle = - 25, hjust = 0.15, vjust = 0.76)) +
  ggtitle("ASS1 in CCC vs Mimics")+
...
p3= p_cth + scale_x_discrete(labels=c("CCC"="ECCC (n=50)","EC" = "EC (n = 136)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)","mixed EC/CCC" = "Mixed EC/CCC (n = 2)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 13)"))+
  theme(axis.text.x=element_text(angle = - 22, hjust = 0.4, vjust = 0.6))  +
  ggtitle("CTH in CCC vs Mimics")+
...
#axis tickmark labels0
p4= p_er + scale_x_discrete(labels=c("CCC"="ECCC (n=50)","EC" = "EC (n = 135)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 14)","mixed EC/CCC" = "Mixed EC/CCC (n = 2)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 9)"))+
 theme(axis.text.x=element_text(angle = - 22, hjust = 0.4, vjust = 0.6))  +
  ggtitle("ER in CCC vs Mimics")+
  scale_color_manual(values = c("#4dc38e",
"#9750a1",
"#759b44",
"#6778d0",
...
#axis tickmark labels0
p5= p_nap + scale_x_discrete(labels=c("CCC"="ECCC (n=50)","EC" = "EC (n = 136)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)","mixed EC/CCC" = "Mixed EC/CCC (n = 2)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 6)"))+
  theme(axis.text.x=element_text(angle = - 22, hjust = 0.4, vjust = 0.6))  +
  ggtitle("Napsin in CCC vs Mimics")+
  scale_color_manual(values = c("#4dc38e",
"#9750a1",
"#759b44",
"#6778d0",
...
p6= p_hnf + scale_x_discrete(labels=c("CCC"="ECCC (n=50)","EC" = "EC (n = 136)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)","mixed EC/CCC" = "Mixed EC/CCC (n = 2)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 13)"))+
  theme(axis.text.x=element_text(angle = - 22, hjust = 0.4, vjust = 0.6))  +
  ggtitle("HNF1B in CCC vs Mimics")+
  scale_color_manual(values = c("#4dc38e",
"#9750a1",
"#759b44",
"#6778d0",
...
```{r}
pdf("asplot2.pdf", width = 16, height = 8.5)
grids
dev.off()
```