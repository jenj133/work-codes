...
keep = c("ASS1","Dx.code","ASS.c1","ASS.c2")
...
p2= p + scale_x_discrete(labels=c("CCC"="CCC (n=62)","EC" = "EC (n = 132)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)","mixed EC/CCC" = "Mixed EC/CCC (n = 2)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 25)"))+
...
#axis tickmark labels0
p3= p_cth + scale_x_discrete(labels=c("CCC"="CCC (n=50)","EC" = "EC (n = 136)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)","mixed EC/CCC" = "Mixed EC/CCC (n = 2)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 13)"))+
  theme(axis.text.x=element_text(angle = - 25, hjust = 0.15, vjust = 0.8))  +
  ggtitle("CTH")+
  scale_color_manual(values = c("#ba4661",
"#56ae6c",
...
#axis tickmark labels0
p4= p_er + scale_x_discrete(labels=c("CCC"="CCC (n=50)","EC" = "EC (n = 135)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 14)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 9)"))+
 theme(axis.text.x=element_text(angle = - 25, hjust = 0.15, vjust = 0.8))  +
  ggtitle("ER")+
  scale_color_manual(values = c("#ba4661",
"#56ae6c",
...
#axis tickmark labels0
p5= p_nap + scale_x_discrete(labels=c("CCC"="CCC (n=50)","EC" = "EC (n = 136)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 14)"))+
  theme(axis.text.x=element_text(angle = - 25, hjust = 0.15, vjust = 0.8))  +
  ggtitle("Napsin")+
  scale_color_manual(values = c("#ba4661",
"#56ae6c",
...
#axis tickmark labels0
p6= p_hnf + scale_x_discrete(labels=c("CCC"="CCC (n=50)","EC" = "EC (n = 136)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)","mixed EC/CCC" = "Mixed EC/CCC (n = 2)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 13)"))+
  theme(axis.text.x=element_text(angle = - 25, hjust = 0.15, vjust = 0.8))  +
  ggtitle("HNF1B")+
  scale_color_manual(values = c("#ba4661",
"#56ae6c",
