...
order <- c("CCC","EC","SC","EC (CC change)","mixed SC/CCC", "AS", "Hyperplasia_w_CC","mixed EC/CCC","Mixed EC/SC")
ass_table$Dx.code <- factor(ass_table$Dx.code, levels = order)

```

```{r}
exclude_dx <- c("Mixed EC/SC","Hyperplasia_w_CC","mixed EC/CCC","mixed SC/CCC")
...
p2= p + scale_x_discrete(labels=c("CCC"="CCC (n=62)","EC" = "EC (n = 132)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)", "AS" = "AS (n = 22)"))+
...
#axis tickmark labels0
p3= p_cth + scale_x_discrete(labels=c("CCC"="CCC (n=50)","EC" = "EC (n = 136)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)", "AS" = "AS (n = 11)"))+
  theme(axis.text.x=element_text(angle = - 25, hjust = 0.15, vjust = 0.8))  +
  ggtitle("CTH")+
  scale_color_manual(values = c("#ba4661",
"#56ae6c",
...
#axis tickmark labels0
p4= p_er + scale_x_discrete(labels=c("CCC"="CCC (n=50)","EC" = "EC (n = 135)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 14)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 7)"))+
 theme(axis.text.x=element_text(angle = - 25, hjust = 0.15, vjust = 0.8))  +
  ggtitle("ER")+
  scale_color_manual(values = c("#ba4661",
"#56ae6c",
...
#axis tickmark labels0
p5= p_nap + scale_x_discrete(labels=c("CCC"="CCC (n=50)","EC" = "EC (n = 136)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)","mixed SC/CCC" = "Mixed SC/CCC (n = 5)", "AS" = "AS (n = 9)"))+
  theme(axis.text.x=element_text(angle = - 25, hjust = 0.15, vjust = 0.8))  +
  ggtitle("Napsin")+
  scale_color_manual(values = c("#ba4661",
"#56ae6c",
...
#axis tickmark labels0
p6= p_hnf + scale_x_discrete(labels=c("CCC"="CCC (n=50)","EC" = "EC (n = 136)","EC (CC change)" = "EC with CC change (n = 5)","SC" = "SC (n = 16)", "AS" = "AS (n = 11)"))+
  theme(axis.text.x=element_text(angle = - 25, hjust = 0.15, vjust = 0.8))  +
  ggtitle("HNF1B")+
  scale_color_manual(values = c("#ba4661",
"#56ae6c",
