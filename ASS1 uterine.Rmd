...
```{r}
cdat <- dat %>% 
  select(row.names=c("TMA","TMA.core.id","Histological.Subtype","patientID", "Accession.num","os.years","os.status" , "dss.years","dss.status","ass1.ihc.consolidated.numeric","MLH1.ihc.consolidated.numeric","MSH2.ihc.consolidated.numeric","MSH6.ihc.consolidated.numeric","PMS2.ihc.consolidated.numeric"))
